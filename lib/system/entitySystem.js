 ...
 * @param {String[]} allComponents - Array of Components Type Name for aspect all components (entity need having all components type of the list)
 * @param {String[]} oneComponents - Array of Components Type Name for aspect one components (entity need having one components type of the list)
 * @param {String[]} excludeComponents - Array of Components Type Name for aspect exclude components (entity need haven't component type of the list)
 */
